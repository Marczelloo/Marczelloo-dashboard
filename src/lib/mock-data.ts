...
export const mockAuditLogs: AuditLog[] = [
  ...
  {
    id: "al999999-9999-9999-9999-999999999991",
    at: minutesAgo(8),
    actor_email: "demo@marczelloo.dev",
    action: "docker_exec",
    entity_type: "container",
    entity_id: null,
    meta_json: { source: "host-console", command: "docker compose -p snippets ps" },
  },
  {
    id: "al999999-9999-9999-9999-999999999992",
    at: minutesAgo(9),
    actor_email: "demo@marczelloo.dev",
    action: "docker_exec_blocked",
    entity_type: "container",
    entity_id: null,
    meta_json: { source: "host-console", command: "rm -rf node_modules", error: "rm is not allowed." },
  },
  {
    id: "al999999-9999-9999-9999-999999999993",
    at: minutesAgo(42),
    actor_email: "demo@marczelloo.dev",
    action: "update",
    entity_type: "env_var",
    entity_id: "ev111111-1111-1111-1111-111111111111",
    meta_json: { key: "DATABASE_URL", service_id: "eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee", value: "postgres://…" },
  },
  {
    id: "al999999-9999-9999-9999-999999999994",
    at: minutesAgo(44),
    actor_email: "demo@marczelloo.dev",
    action: "reveal_secret",
    entity_type: "env_var",
    entity_id: "ev111111-1111-1111-1111-111111111111",
    meta_json: { key: "DATABASE_URL", service_id: "eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee" },
  },
  {
    id: "al999999-9999-9999-9999-999999999995",
    at: hoursAgo(5),
    actor_email: "demo@marczelloo.dev",
    action: "rollback",
    entity_type: "project",
    entity_id: "44444444-4444-4444-4444-444444444444",
    meta_json: { sha: "9f1c2e7a0b3d4c5e6f708192a3b4c5d6e7f80912" },
  },
  {
    id: "al999999-9999-9999-9999-999999999996",
    at: hoursAgo(6),
    actor_email: "github-webhook",
    action: "github_webhook_trigger",
    entity_type: "project",
    entity_id: "44444444-4444-4444-4444-444444444444",
    meta_json: { event: "push", branch: "main", commits: 2, headCommit: "4b7e9d21", message: "feat: tag search" },
  },
  {
    id: "al999999-9999-9999-9999-999999999997",
    at: daysAgo(1),
    actor_email: "demo@marczelloo.dev",
    action: "create",
    entity_type: "release",
    entity_id: "11111111-1111-1111-1111-111111111111",
    meta_json: { project: "AtlasHub", tag: "v1.4.0", draft: false },
  },
  {
    id: "al999999-9999-9999-9999-999999999998",
    at: daysAgo(2),
    actor_email: "demo@marczelloo.dev",
    action: "pin_verify",
    entity_type: "auth",
    entity_id: null,
    meta_json: { success: false },
  },
  {
    id: "al999999-9999-9999-9999-999999999999",
    at: daysAgo(4),
    actor_email: "demo@marczelloo.dev",
    action: "update",
    entity_type: "service",
    entity_id: "aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa",
    meta_json: { fields: ["health_url", "port"] },
  },
];
